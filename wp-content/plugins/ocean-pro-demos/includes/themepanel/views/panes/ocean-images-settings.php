			...
			<tbody>
					<tr id="owp_api_images_integration_server_tr">
						...
						<td>
							...
							<p class="oceanwp-tp-block-description" style="font-size: 11px;font-style: italic;"><?php esc_html_e( '*In case of image or icon import problems and / or errors, switch to the Alternative server for troubleshooting purposes. Otherwise, use the Main server at all times.', 'ocean-pro-demos' ); ?></p>
						</td>
					</tr>
