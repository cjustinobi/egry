...
final class Ocean_Popup_Login {
	...
	public function scripts() {
		...
		wp_enqueue_script( 'opl-js-script', plugins_url( '/assets/js/popup-login.min.js', __FILE__ ), array( 'oceanwp-main', 'axios' ), $this->version, true );
	}
	...
	public function oe_theme_panels( $panels ) {
		...
		$panels['ocean_popup_login_panel'] = [
